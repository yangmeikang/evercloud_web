...
CloudApp.controller('HeaderController',
    ['$rootScope', '$scope', '$http', '$interval', 'Feed', 'UserProfileService',
...
CloudApp.config(['$stateProvider', '$urlRouterProvider', 'current_user', 'site_config',
    function ($stateProvider, $urlRouterProvider, current_user, site_config) {
        ...
        $stateProvider
            ...
            .state('overview', {
                ...
                resolve: {
                    ...
                    workflowStatus: function (FlowInstance) {
                        if (site_config.WORKFLOW_ENABLED) {
            ...
            .state("lbaasinfo", {
                ...
                resolve: {
                    ...
                    balancer: function ($stateParams, CommonHttpService) {
                        return CommonHttpService.get("/api/lbs/" + $stateParams.balancer_id + "/");
                    }
                }
            })
            // router
            ...
            .state("orders", {
                url: "/orders/",
                templateUrl: "/static/cloud/views/order.html",
                data: {pageTitle: 'Resource Order'},
                    ...
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            ...
                            files: [
                                '/static/assets/global/plugins/bootstrap-datepicker/css/datepicker3.css',
                                '/static/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js',
                                '/static/cloud/controllers/order_ctrl.js'
                            ]
                        });
                    }]
                }
            ...
            .state("bills", {
                url: "/bills/",
                templateUrl: "/static/cloud/views/bill.html",
                data: {pageTitle: 'Bill'},
                resolve: {
                    deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            ...
                            files: [
                                ...
                                '/static/assets/global/plugins/bootstrap-datepicker/css/datepicker3.css',
                                '/static/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js',
                                '/static/cloud/controllers/bill_ctrl.js'
                            ]
                        });
                    }]
                }
...
CloudApp.run(["$rootScope", "settings", "$state", "$http", "$cookies",
    "$interval", "CommonHttpService", "current_user", "site_config", "Choice",
